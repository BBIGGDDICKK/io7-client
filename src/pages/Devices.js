    ...
    {chosenDevice ? (
      ...
      <>
        ...
        <header className="mb-8 flex items-center justify-between">
          <h1 className="text-slate-900 text-4xl font-bold tracking-tight">디바이스 목록</h1>
          <button
              ...
              <tbody className="divide-y divide-slate-200">
                {rows.map((row) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap" id={row.id + '-status'}>
                      <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold ${
                        ...
                        <span className="material-icons text-sm mr-1.5">
                          {row.online === '온라인' || row.online === 'Online' ? 'wifi' : 'wifi_off'}
                        </span>
                        {row.online}
                      </span>
                    </td>
